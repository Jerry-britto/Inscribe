                            ...
                            children:<Widget>[
                              const Center(
                                child: Row(
                                  children: <Widget>[
                                    SizedBox(width:60),
                                    Text("SWD", style: TextStyle(color: Color(0xCCA20730), fontSize: 15, fontWeight: FontWeight.bold)),
                                    SizedBox(width:90),
                                    Text("Scribe", style: TextStyle(color: Color(0xCCA20730), fontSize: 15, fontWeight: FontWeight.bold)),
                                  ],
                                ),
                              ),
                              AnimatedPositioned(
